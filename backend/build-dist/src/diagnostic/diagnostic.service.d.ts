...
export declare class DiagnosticService {
    ...
    getProfileForAdmin(diagnosticId: string): Promise<{
        diagnostic: {
            id: string;
            fullName: string | null;
            avatarUrl: string | null;
    ...
    private updateDiagnosticProfile;
    ...
    updateProfileForAdmin(diagnosticId: string, dto: UpdateDiagnosticMyProfileDto): Promise<{
        diagnostic: {
            id: string;
            fullName: string | null;
            avatarUrl: string | null;
