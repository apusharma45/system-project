...
const doctors = [
    {
        ...
        about: 'Consultant cardiologist focused on hypertension, preventive cardiac care, and long-term chronic disease management.',
    ...
    },
    {
        ...
        about: 'Dermatologist managing chronic eczema, acne, fungal infections, and allergy-driven skin conditions.',
    ...
    },
    {
        ...
        certifications: ['PALS'],
        yearsOfExperience: 9,
        about: 'Pediatric specialist supporting childhood fever, nutrition concerns, asthma follow-up, and routine care.',
    ...
    },
    {
        ...
        about: 'Orthopedic surgeon for joint pain, spine-related discomfort, minor trauma, and rehabilitation planning.',
    ...
    },
    {
        ...
        about: 'Endocrinologist treating diabetes, thyroid disorders, metabolic conditions, and long-term lifestyle guidance.',
    ...
    try {
        ...
        const appointmentTwo = await prisma.appointment.create({
            data: {
                ...
                status: client_1.AppointmentStatus.EXAM_DONE,
        ...
        const appointmentFive = await prisma.appointment.create({
            data: {
                ...
                status: client_1.AppointmentStatus.CLOSED,
        ...
        const mehediLabOrder = await prisma.labOrder.create({
            data: {
                ...
                status: client_1.LabOrderStatus.ASSIGNED,
        ...
        const sadiaLabOrder = await prisma.labOrder.create({
            data: {
                ...
                status: client_1.LabOrderStatus.SENT,
                tests: [
            ...
            data: [
                {
                    ...
                    status: client_1.PrescriptionStatus.SENT_TO_PHARMACY,
                ...
                },
                {
                    ...
                    status: client_1.PrescriptionStatus.SENT_TO_PATIENT,
            ...
            data: [
                {
                    ...
                    type: client_1.NotificationType.APPOINTMENT_CALLED,
                ...
                },
                {
                    ...
                    type: client_1.NotificationType.LAB_ASSIGNED,
                ...
                },
                {
                    ...
                    type: client_1.NotificationType.LAB_RESULT_UPLOADED,
                ...
                },
                {
                    ...
                    type: client_1.NotificationType.PRESCRIPTION_READY,
...
//# sourceMappingURL=seed-bangladesh.js.map